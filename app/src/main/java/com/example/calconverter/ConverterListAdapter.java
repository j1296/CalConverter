...
public class ConverterListAdapter extends ArrayAdapter<ExchangeRate> {
    ...
    public ConverterListAdapter(Context context, int resource, List<ExchangeRate> items) {
